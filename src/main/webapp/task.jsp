                                    ...
                                    <tbody>
                                    	<c:forEach var="item" items="${listTask }">
	                                    	<tr>
	                                            <td>${item.idCV }</td>
	                                            <td>${item.ten }</td>
	                                            <td>${item.duan.tenduan }</td>
	                                            <td>${item.nguoidung.fullname }</td>
	                                            <td>${item.ngaybatdau }</td>
	                                            <td>${item.ngayketthuc }</td>
	                                            <td>${item.trangthai.ten }</td>
	                                            <td>
	                                                <a href="task-edit?id=${item.idCV }" class="btn btn-sm btn-primary">Sửa</a>
	                                                <a href="" id-task=${item.idCV } class="btn btn-sm btn-danger btn-xoa">Xóa</a>
