                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<c:url value='${action }'/>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="${ltv.ten}" name="ten" placeholder="Tên quyền" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="${ltv.mota}" name="mota" placeholder="Mô tả" class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
